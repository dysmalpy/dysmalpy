...
PACKAGENAME = metadata.get('package_name', 'dysmalpy')
DESCRIPTION = metadata.get('description', 'Dynamical Simulation and Modeling Algorithm')
AUTHOR = metadata.get('author', 'MPE/IR-Submm Group')
