...
def setup_dysmalpy_fitting(ndim=None):
    ...
    # 'minAF': None,
    # 'maxAF': None,
    mcmc_settings_kwargs = {'nWalkers': 500, 
                'nCPUs': 8,
                'scale_param_a': 2,
                'nBurn': 300, 
                'nSteps': 1000,
    ...
    # # FOR DEBUGGING:
    # mcmc_settings_kwargs = {'nWalkers': 2, 
    #             'nCPUs': 1,
    #             'scale_param_a': 2,
    #             'nBurn': 300, 
    #             'nSteps': 1000,
    ...
    return gal, mcmc_settings_kwargs
